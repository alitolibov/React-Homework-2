...
function App() {
    ...
    <div className="w-[94.3%] m-auto mt-[30px] mb-[50px]">
      <button className="py-[19px] px-[54px] m-auto mb-[50px] text-[#ffffff] block bg-[#00AC73] rounded-[15px] cursor-pointer">Подробнее</button>
      ...
      <p className="text-[24px] leading-[25px] mb-[24px]">Наши товары делают жизнь комфортной и безопасной. Высокий уровень сервиса и понимания к каждому покупателю.</p>
      ...
      <div className="flex flex-col gap-[8px]">
        ...
        <p className="text-[14px] text-[#7E7E7E]">Решаем неудовлетворенные потребности покупателей, ценим клиентов как деловых партнеров</p>
      </div>
      <div className="flex flex-col gap-[8px]">
      ...
      <div className="h-[438px] bg-[#00504D] rounded-[30px] py-[24px] px-[33px] flex flex-col">
        <p className="text-[#ffffff] text-[24px] leading-[29px] text-center">Пользуйтесь нашим приложением для большего удобства</p>
        <div className="h-[303px] flex items-center justify-center"></div>
      </div>
    </div>
    </>
    )

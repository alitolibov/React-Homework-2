...
const PageOne = () => {
   ...
   <div
        className="h-[300px] bag relative bg-no-repeat overflow-hidden rounded-[30px] bg-cover lg:h-[400px]">
        <div
            className="absolute w-full h-full inset-0 bg-[#00AC7340] flex flex-col items-center py-[24px] gap-[24px] lg:justify-center">
            <p
   ...
   <div className="bg-[#f2f2f2]">
    <div className="w-[94.3%] m-auto py-[50px] bg-[#f2f2f2] lg:w-[96.3%]">
        <div className="sm:w-[95%] grid grid-cols-2 m-auto gap-[12px] md:hidden">
            <Item/>
            <Item/>
        </div> 
        <div className="sm:w-[95%] hidden grid-cols-3 m-auto gap-[12px] md:grid lg:gap-[20px]">
            <Item/>
            <Item/>
            <Item/>
        </div>
...
<div className="w-[94.3%] m-auto mt-[30px] mb-[50px] lg:w-[96.3%]">
    <button
    ...
    <div className="w-[95%] hidden grid-cols-3 m-auto mb-[30px] gap-[12px] md:grid lg:gap-[20px]">
        <Item/>
        <Item/>
        <Item/>
        <Item/>
    ...
    <div className="lg:flex gap-[24px] mb-[24px] lg:w-full items-center justify-center m-auto">
    <div className="bigbg w-full h-[404px] bg-contain mb-[30px] bg-no-repeat md:m-auto md:w-[404px] lg:w-[460px] lg:mx-[0px] lg:h-[460px] lg:bg-cover"></div>
    <p className="text-[24px] leading-[25px] mb-[24px] md:mt-[30px] lg:hidden">Наши товары делают жизнь
        комфортной и безопасной. Высокий уровень сервиса и понимание к каждому
        покупателю.</p>
    <div className="flex flex-col gap-[16px] mb-[50px] lg:w-[480px] my-[0px]">
    <p className="text-[24px] leading-[25px] hidden lg:block">Наши товары делают жизнь
        комфортной и безопасной. Высокий уровень сервиса и понимание к каждому
        покупателю.</p>
        <div className="flex flex-col gap-[8px]">
            <p className="lg:text-[19px]">01. Большой ассортимент</p>
            <p className="text-[14px] text-[#7E7E7E]">Для ванной комнаты с различным покрытием</p>
        </div>
        <div className="flex flex-col gap-[8px]">
            <p className="lg:text-[19px]">02. Доступные цены</p>
            <p className="text-[14px] text-[#7E7E7E]">Сантехника под любой запрос</p>
        </div>
        <div className="flex flex-col gap-[8px]">
            <p className="lg:text-[19px]">03. Высокий уровень сервиса</p>
            <p className="text-[14px] text-[#7E7E7E]">Решаем неудовлетворенные потребности
                покупателей, ценим клиентов как деловых партнеров</p>
        </div>
        <div className="flex flex-col gap-[8px]">
            <p className="lg:text-[19px]">04. Круглосуточная доставка</p>
    ...
    <div className="appbg w-[738px] h-[220px] m-auto bg-contain bg-no-repeat hidden md:block lg:w-[878px] bg-cover lg:h-[270px]"></div>
</div>
   </>
   );
}
